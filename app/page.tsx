      ...
      <header className="border-b border-muted bg-muted/10 backdrop-blur-sm sticky top-0 z-50">
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-semibold text-foreground">Japanese Character Identifier</h1>
              <p className="text-sm text-muted-foreground">Draw & identify Japanese characters</p>
            </div>
            <AuthHeader />
          </div>
        </div>
